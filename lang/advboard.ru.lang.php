...
$L['cfg_firstCrumbText'] = 'Название главной страницы в хлебных крошках';
$L['cfg_firstCrumbText_hint'] = 'По умолчанию &laquo;'.$L['advboard_ads'].'&raquo;. Если значение пусто и задано &laquo;Название главной страницы&raquo; (ниже), то используется оно.<br /> 
Также можно использовать &laquo;$L[\'advboard_breadcrumbs_main_title\']&raquo;';
$L['cfg_mainTitle'] = 'Название главной страницы доски объявлений';
$L['cfg_mainTitle_hint'] = 'По умолчанию &laquo;'.$L['advboard_ads_board'].'&raquo;. Также можно использовать &laquo;$L[\'advboard_main_title\']&raquo;';
